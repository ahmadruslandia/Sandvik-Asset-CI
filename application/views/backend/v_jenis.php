...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    <li class="droplink"><a href="<?php echo site_url('backend/dashboard'); ?>" class="waves-effect waves-button"><span class="menu-icon icon-home"></span>
                            <p>Dashboard</p>
                        </a></li>
                    ...
                    <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon fa fa-file-o"></span>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active"><a href="<?php echo site_url('backend/jenis'); ?>">Status</a></li>
                        </ul>
                    </li>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" data-id="<?php echo $row->id_jenis; ?>" data-jenis="<?php echo $row->nama_jenis; ?>"><span class="fa fa-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?php echo $row->id_jenis; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!--ADD RECORD MODAL-->
    <form action="<?php echo site_url('backend/jenis/save'); ?>" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" name="jenis" class="form-control" placeholder="Jenis Status" required>
                        </div>
                    </div>
    ...
    <!--EDIT RECORD MODAL-->
    <form action="<?php echo site_url('backend/jenis/edit'); ?>" method="post">
        <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" name="jenis2" class="form-control" placeholder="Nama Jenis" required>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <!--DELETE RECORD MODAL-->
    <form action="<?php echo site_url('backend/jenis/delete'); ?>" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            Anda yakin mau menghapus Jenis ini?
                        </div>
                    </div>
                    <div class="modal-footer">
