...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink active open"><a href=" #" class="waves-effect waves-button"><span class="menu-icon fa fa-file-o"></span>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active"><a href="<?php echo site_url('backend/network'); ?>">Network</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;"><?php echo $row->network_id; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->date_manufacture; ?></td>
                                                ...
                                                <td style="vertical-align: middle;"><?php echo $row->type_network; ?></td>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->id_network ?>"><span class="icon-pencil"></span> Edit</a></li>
                                                            <li><a href="javascript:void(0);" class="delete" data-prdid="<?php echo $row->id_network ?>"><span class="icon-trash"></span> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                        <li><a href="<?php echo site_url('backend/network/pdf'); ?>"> Pdf</a></li>
                                                        <li><a href="<?php echo site_url('backend/network/excel'); ?>"> Excel</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/network/insert' ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="ntwid" class="form-control" placeholder="Network ID" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" name="tp" class="form-control" placeholder="Type" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="wr" class="form-control" placeholder="Warranty" required>
                                </div>
                                <div class="form-group">
    ...
    ?>
        ...
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url() . 'backend/network/update' ?>" method="post" enctype="multipart/form-data">
            <div class="modal fade" id="ModalEdit<?php echo $row->id_network ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="ntwid" value="<?php echo $row->assets_name; ?>" class="form-control" placeholder="Network ID" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="date" name="dt" value="<?php echo $row->date_manufacture; ?>" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="tp" value="<?php echo $row->type_network; ?>" class="form-control" placeholder="Type" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="wr" value="<?php echo $row->warranty; ?>" class="form-control" placeholder="Warranty" required>
                                    </div>
                                    <div class="form-group">
                                        <select class="form-control" name="jenis" required>
                                            <option value="">-Select Option-</option>
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="idprd" value="<?php echo $row->id_network ?>" required>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
    ...
    <!-- Modal hapus-->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/network/delete' ?>" method="post" enctype="multipart/form-data">
