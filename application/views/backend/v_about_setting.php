                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="about_address" class="form-control" rows="6"><?php echo $about_address; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" name="about_email" class="form-control" id="input1" value="<?php echo $about_email; ?>" placeholder="Email">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Telepon</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="about_telephone" class="form-control" id="input1" value="<?php echo $about_telephone; ?>" placeholder="Telepon">
                                        </div>
                                    </div>
