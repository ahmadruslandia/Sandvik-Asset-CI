...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink active open"><a href=" #" class="waves-effect waves-button"><span class="menu-icon fa fa-file-o"></span>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active"><a href="<?php echo site_url('backend/handphone'); ?>">Handphone</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;"><?php echo $row->street_address; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->user_name; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->model; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->departement; ?></td>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->id_handphone ?>"><span class="icon-pencil"></span> Edit</a></li>
                                                            <li><a href="javascript:void(0);" class="delete" data-prdid="<?php echo $row->id_handphone ?>"><span class="icon-trash"></span> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                        <li><a href="<?php echo site_url('backend/handphone/pdf'); ?>"> Pdf</a></li>
                                                        <li><a href="<?php echo site_url('backend/handphone/excel'); ?>"> Excel</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/handphone/insert' ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" name="stradr" class="form-control" placeholder="Street Address" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="ussnm" class="form-control" placeholder="User Name" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="md" class="form-control" placeholder="Model" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="dpt" class="form-control" placeholder="Departement" required>
                                </div>
                                <div class="form-group">
    ...
    ?>
        ...
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url() . 'backend/handphone/update' ?>" method="post" enctype="multipart/form-data">
            <div class="modal fade" id="ModalEdit<?php echo $row->id_handphone ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="stradr" value="<?php echo $row->street_address; ?>" class="form-control" placeholder="Street Address" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="ussnm" value="<?php echo $row->user_name; ?>" class="form-control" placeholder="User Name" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="md" value="<?php echo $row->model; ?>" class="form-control" placeholder="Model" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="dpt" value="<?php echo $row->departement; ?>" class="form-control" placeholder="Departement" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="ussid" value="<?php echo $row->user_id; ?>" class="form-control" placeholder="User ID" required>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="idprd" value="<?php echo $row->id_handphone ?>" required>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
    ...
    <!-- Modal hapus-->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/handphone/delete' ?>" method="post" enctype="multipart/form-data">
