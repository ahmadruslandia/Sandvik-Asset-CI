        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon fa fa-file-o"></span>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;"><?php echo $row->user_number; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->user_email; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->user_area; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->user_division; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->user_room; ?></td>
                                                <td style="vertical-align: middle;">
                                                    <?php
                                                    if ($row->user_level == '1') {
                                                        echo "Administrator";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" name="di" class="form-control" placeholder="User ID" required>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <input type="text" name="di" value="<?php echo $row->user_di; ?>" class="form-control" placeholder="User ID" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="nama" value="<?php echo $row->user_name; ?>" class="form-control" placeholder="Name" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="number" value="<?php echo $row->user_number; ?>" class="form-control" placeholder="Number" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="area" value="<?php echo $row->user_area; ?>" class="form-control" placeholder="Area" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="division" value="<?php echo $row->user_division; ?>" class="form-control" placeholder="Division" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="room" value="<?php echo $row->user_room; ?>" class="form-control" placeholder="Room" required>
                                    </div>
                                    <div class="form-group">
                                        <select class="form-control" name="level" required>
                                            <?php if ($row->user_level == '1') : ?>
                                            ...
                                            <?php else : ?>
                                                <option value="1">Administrator</option>
                                                <option value="2" selected>Employe</option>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                </div>
