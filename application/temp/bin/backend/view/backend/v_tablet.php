...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink active open"><a href=" #" class="waves-effect waves-button"><span class="menu-icon fa fa-file-o"></span>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active"><a href="<?php echo site_url('backend/tablet'); ?>">Tablet</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;"><?php echo $row->tablet_date; ?></td>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->id_tablet ?>"><span class="icon-pencil"></span> Edit</a></li>
                                                            <li><a href="javascript:void(0);" class="delete" data-prdid="<?php echo $row->id_tablet ?>"><span class="icon-trash"></span> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                        <li><a href="<?php echo site_url('backend/tablet/pdf'); ?>"> Pdf</a></li>
                                                        <li><a href="<?php echo site_url('backend/tablet/excel'); ?>"> Excel</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/tablet/insert' ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="hdd" class="form-control" placeholder="Hard Disk" required>
                                </div>
                                <div class="form-group">
    ...
    ?>
        ...
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url() . 'backend/tablet/update' ?>" method="post" enctype="multipart/form-data">
            <div class="modal fade" id="ModalEdit<?php echo $row->id_tablet ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="date" name="dt" value="<?php echo $row->tablet_date; ?>" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="hdd" value="<?php echo $row->hard_disk; ?>" class="form-control" placeholder="Hard Disk" required>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="idmon" value="<?php echo $row->id_tablet ?>" required>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
    ...
    <!-- Modal hapus-->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/tablet/delete' ?>" method="post" enctype="multipart/form-data">
