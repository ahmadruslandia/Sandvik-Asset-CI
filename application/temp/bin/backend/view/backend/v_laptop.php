...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
            ...
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink active open""><a href=" #" class="waves-effect waves-button"><span class="menu-icon fa fa-file-o"></span>
                        ...
                        <ul class="sub-menu">
                            <li class="active"><a href="<?php echo site_url('backend/laptop'); ?>">Laptop</a></li>
                            ...
                            <li><a href="<?php echo site_url('backend/orbit'); ?>">Orbit</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;"><?php echo $row->laptop_date; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->laptop_model; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->brand; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->user_di; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->serial_number; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->mac_address; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->hard_disk; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->processor; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->operating_system; ?></td>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->id_laptop ?>"><span class="icon-pencil"></span> Edit</a></li>
                                                            <li><a href="javascript:void(0);" class="delete" data-laptopid="<?php echo $row->id_laptop ?>"><span class="icon-trash"></span> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                        <li><a href="<?php echo site_url('backend/laptop/pdf'); ?>"> Pdf</a></li>
                                                        <li><a href="<?php echo site_url('backend/laptop/excel'); ?>"> Excel</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/laptop/insert' ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="lapmod" class="form-control" placeholder="Model" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="brn" class="form-control" placeholder="Brand" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="ussid" class="form-control" placeholder="User ID" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="sn" class="form-control" placeholder="Serial Number" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="ma" class="form-control" placeholder="MAC Address" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="hd" class="form-control" placeholder="Hard Disk" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="prc" class="form-control" placeholder="Processor" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="os" class="form-control" placeholder="Operating System" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="rm" class="form-control" placeholder="Room" required>
                                </div>
                                <div class="form-group">
    ...
    ?>
        ...
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url() . 'backend/laptop/update' ?>" method="post" enctype="multipart/form-data">
            <div class="modal fade" id="ModalEdit<?php echo $row->id_laptop ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="date" name="dt" value="<?php echo $row->laptop_date; ?>" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="lapmod" value="<?php echo $row->laptop_model; ?>" class="form-control" placeholder="Model" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="brn" value="<?php echo $row->brand; ?>" class="form-control" placeholder="Brand" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="ussid" value="<?php echo $row->user_di; ?>" class="form-control" placeholder="User ID" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="sn" value="<?php echo $row->serial_number; ?>" class="form-control" placeholder="Serial Number" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="ma" value="<?php echo $row->mac_address; ?>" class="form-control" placeholder="MAC Address" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="hd" value="<?php echo $row->hard_disk; ?>" class="form-control" placeholder="Hard Disk" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="prc" value="<?php echo $row->processor; ?>" class="form-control" placeholder="Processor" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="os" value="<?php echo $row->operating_system; ?>" class="form-control" placeholder="Operating System" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="rm" value="<?php echo $row->room; ?>" class="form-control" placeholder="Room" required>
                                    </div>
                                    <div class="form-group">
                                        <select class="form-control" name="jenis" required>
                                            <option value="">-Select Option-</option>
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="idlap" value="<?php echo $row->id_laptop ?>" required>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
    ...
    <!-- Modal hapus-->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/laptop/delete' ?>" method="post" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.delete').on('click', function() {
                var laptopid = $(this).data('laptopid');
                $('#ModalDelete').modal('show');
                $('[name="kode"]').val(laptopid);
            });
        });
    </script>
