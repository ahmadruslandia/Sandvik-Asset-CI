...
header("Content-Disposition: attachment; filename=laptop_report_excel.xls");
?>
<html>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td align="center"><?php echo $sl->laptop_date; ?></td>
                    <td align="center"><?php echo $sl->laptop_model; ?></td>
